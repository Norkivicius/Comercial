...
begin
  ...
  begin
    MessageDlg('Você não possui esse recurso entre em contato com o fabricante',mtWarning,[mbok],0)
  end;
...
//  begin
//    MessageDlg('Você não logou corretamente. A aplicação será encerrada',mtInformation, mbOKCancel,0);
