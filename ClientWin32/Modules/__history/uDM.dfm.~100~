object DM: TDM
  ...
  object DBAcesso: TSQLConnection
    ...
    Params.Strings = (
      ...
      'VendorLibOsx=/Library/Frameworks/Firebird.framework/Firebird'
        ...
        'Database=C:\Users\Rafael Cefaloni\Desktop\Arquivos Delphi\Comerc' +
        'ial\DB\DBVENDAS.fdb'
      'User_Name=sysdba'
      'Password=masterkey'
      'Role=RoleName'
  ...
  object sdsConsulta: TSQLDataSet
    ...
    Left = 54
    Top = 375
    object sdsConsultaPRODUTO: TIntegerField
      FieldName = 'PRODUTO'
      Required = True
    end
    ...
    object sdsConsultaESTOQUE: TSingleField
      FieldName = 'ESTOQUE'
    end
    object sdsConsultaPRECO: TSingleField
      FieldName = 'PRECO'
    end
    object sdsConsultaFABRICANTE: TStringField
      FieldName = 'FABRICANTE'
      Size = 75
    end
    object sdsConsultaCATEGORIA: TStringField
      FieldName = 'CATEGORIA'
      Size = 75
    end
  end
