...
begin
  raise Exception.Create('Para obeter a instancia TUsuarios use a função TUsuario.getinstance!');
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      MessageDlg('É necessário estar logado para invocar esse método !!',mtWarning,[mbOK],0);
  end;
end;
